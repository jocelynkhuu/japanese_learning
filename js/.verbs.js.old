const verbs = [
    ...
    te: ["かして","貸して"], masu: ["かします","貸します"], meaning: "to lend", lesson: "other"},
    ...
    te: ["とって","取って"], masu: ["とります","取ります"], meaning: "to take (a class); to get (a grade) (~を)", lesson: 11},
    ...
    te: ["なくして","失くして"], masu: ["なくします","失くします"], meaning: "to lose", lesson: 12},
    ...
    te: ["はじまって","始まって"], masu: ["はじまります","始まります"], meaning: "something begins", lesson: 9},
    ...
    te: ["はらって","払って"], masu: ["はらいます","払います"], meaning: "to pay", lesson: 12},
    ...
    te: ["くすりをのんで","薬を飲んで"], masu: ["くすりをのみます","薬を飲みます","くすりを飲んで"], meaning: "to take medicine", lesson: 9},
    ...
    te: ["うそをついて"], masu: ["うそをつきます"], meaning: "to tell a lie", lesson: 11},
    {dict: "おなかがすく", type: "u-verb",
    te: ["おなかがすいて"], masu: ["おなかがすきます"], meaning: "to become hungry", lesson: 11},
    {dict: "かう", kanji: "<ruby>飼<rt>か</rt></ruby>う", type: "u-verb",
    te: ["かって","飼って"], masu: ["かいます","飼います"], meaning: "to own (a pet) (~を)", lesson: 11},
    {dict: "サボる", type: "u-verb",
    te: ["サボって"], masu: ["サボります"], meaning: "to cut (classes) (~を)", lesson: 11},
    {dict: "ならう", kanji: "<ruby>習<rt>な</rt></ruby>らう", type: "u-verb",
    te: ["ならって","習って"], masu: ["ならいます","習います"], meaning: "to learn (~を)", lesson: 11},      
    {dict: "のぼる", kanji: "<ruby>登<rt>の</rt></ruby>ぼる", type: "u-verb",
    te: ["のぼって","登って"], masu: ["のぼります","登ります"], meaning: "to climb (place に)", lesson: 11},
    {dict: "はしる", kanji: "<ruby>走<rt>はし</rt></ruby>る", type: "u-verb",
    te: ["はしって","走って"], masu: ["はしります","走ります"], meaning: "to run", lesson: 11},
    {dict: "あるく", kanji: "<ruby>歩<rt>ある</rt></ruby>く", type: "u-verb",
    te: ["あるいて","歩いて"], masu: ["あるきます","歩きます"], meaning: "to walk", lesson: 12},
    {dict: "かぜをひく", kanji: "<ruby>風<rt>かぜ</rt></ruby>を<ruby>引<rt>ひ</rt></ruby>く", type: "u-verb",
    te: ["かぜをひいて","風を引いて"], masu: ["かぜをひきます","風を引きます"], meaning: "to catch a cold", lesson: 12},
    {dict: "ねつがある", kanji: "<ruby>熱<rt>ねつ</rt></ruby>がある", type: "u-verb",
    te: ["ねつがあって","熱があって"], masu: ["ねつがあります","熱があります"], meaning: "to have a fever", lesson: 12},
    {dict: "のどがかわく", kanji: "のどが<ruby>渇<rt>かわ</rt></ruby>く", type: "u-verb",
    te: ["のどがかわいて","のどが渇いて"], masu: ["のどがかわきます","のどが渇きます"], meaning: "to become thirsty", lesson: 12},
    {dict: "きょうみがある", kanji: "<ruby>興味<rt>きょうみ</rt></ruby>がある", type: "u-verb",
    te: ["きょうみがあって","興味があって"], masu: ["きょうみがあります","興味があります"], meaning: "to be interested in (~に)", lesson: 12},
    ...
    te: ["あげて","上げて"], masu: ["あげます","上げます"], meaning: "to give", lesson: "other"},
    ...
    te: ["つけて"], masu: ["つけます"], meaning: "to turn on", lesson: 6},
    ...
    te: ["でて","出て"], masu: ["でます","出ます"], meaning: "to leave", lesson: [6, 9]},
    ...
    {dict: "つかれる", kanji: "<ruby>疲<rt>つか</rt></ruby>れる", type: "ru-verb",
    te: ["つかれて","疲れて"], masu: ["つかれます","疲れます"], meaning: "to get tired", lesson: 11},
    {dict: "やめる", type: "ru-verb",
    te: ["やめて"], masu: ["やめます"], meaning: "to quit (~を)", lesson: 11},
    {dict: "せきがでる", kanji: "<ruby>咳<rt>せき</rt></ruby>がでる", type: "ru-verb",
    te: ["せきがでて","咳が出て"], masu: ["せきがでます","咳が出ます"], meaning: "to cough", lesson: 12},
    {dict: "わかれる", kanji: "<ruby>別<rt>わか</rt></ruby>れる", type: "ru-verb",
    te: ["わかれて","別れて"], masu: ["わかれます","別れます"], meaning: "to break up; to separate (person と)", lesson: 12},
    ...
    {dict: "けんかする", type: "irregular",
    te: ["けんかして"], masu: ["けんかします"], meaning: "to have a fight; to quarral", lesson: 11},
    {dict: "じょうかいする", kanji: "<ruby>紹介<rt>しょうかい</rt></ruby>する", type: "irregular",
    te: ["しょうかいして","紹介して"], masu: ["しょうかいします","紹介します"], meaning: "to introduce (person に person を)", lesson: 11},
    {dict: "ちこくする", kanji: "<ruby>遅刻<rt>ちこく</rt></ruby>する", type: "irregular",
    te: ["ちこくして","遅刻して"], masu: ["ちこくします","遅刻します"], meaning: "to be late (for an appointment) (~に)", lesson: 11},
    {dict: "きんちょうする", kanji: "<ruby>緊張<rt>きんちょう</rt></ruby>する", type: "irregular",
    te: ["きんちょうして","緊張して"], masu: ["きんちょうします","緊張します"], meaning: "to get nervous", lesson: 12},
    {dict: "しんぱいする", kanji: "<ruby>心配<rt>しんぱい</rt></ruby>する", type: "irregular",
    te: ["しんぱいして","心配して"], masu: ["しんぱいします","心配します"], meaning: "to worry", lesson: 12},
];
